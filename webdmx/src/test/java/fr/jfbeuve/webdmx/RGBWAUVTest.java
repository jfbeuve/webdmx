...
public class RGBWAUVTest {
    ...
    public void eval() throws Exception {
        ...
        assertEquals(0, f.amber(new RGBFixtureState(0,0,255,0,255,false)));
        ...
        assertEquals(255, f.amber(new RGBFixtureState(0,0,255,128,0,false)));
        assertEquals(127, f.amber(new RGBFixtureState(0,0,255,64,0,false)));
        assertEquals(126, f.amber(new RGBFixtureState(0,0,255,192,0,false)));
    }
}
